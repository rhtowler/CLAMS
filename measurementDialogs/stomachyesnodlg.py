...
class StomachYesNoDlg(QDialog, ui_YesNoDlg.Ui_YesNoDlg):
    def __init__(self,  parent=None):
        super(StomachYesNoDlg, self).__init__(parent)
        self.setupUi(self)
        ...
        #  set the caption
        self.setCaption('Are you taking a stomach?')
