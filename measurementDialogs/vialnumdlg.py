...
class VialNumDlg(QDialog, ui_NumPad.Ui_numpad):

    def __init__(self, parent=None):
        super(VialNumDlg, self).__init__(parent)
        self.setupUi(self)

        self.value = None
        self.msgLabel.setText('Enter Vial Number')
    ...
    def Enter(self):
        self.result=(True, self.dispBox.text())
        self.dispBox.setText("")
        self.accept()
