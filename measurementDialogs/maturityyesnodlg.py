...
class MaturityYesNoDlg(QDialog, ui_YesNoDlg.Ui_YesNoDlg):
    def __init__(self,  parent=None):
        super(MaturityYesNoDlg, self).__init__(parent)
        self.setupUi(self)
        ...
        #  set the caption
        self.setCaption('Is this one a spawner?')
