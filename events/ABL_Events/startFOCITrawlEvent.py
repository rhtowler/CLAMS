'''
startFOCITrawlEvent is a helper function used to launch the FOCI trawl event.
...
import FOCITrawlEvent
import eventseldlg
import interactioncheckdlg

class startFOCITrawlEvent():
    ...
    def __init__(self, parent):
        ...
        if hlDialog.exec_():
            ...
            trawlEvent = FOCITrawlEvent.FOCITrawlEvent(self.parent)
            trawlEvent.exec_()
